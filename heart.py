...
def getDataFromSample(sample):
    ...
    #The values received manually are slightly different (more accurate and more decimals) than the given information on heartmeta.txt
    #The numbers in the comments are data from heartmeta.txt for simplicity sakes.
